...
@section('content')
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.program_reports.store') }}">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="important_notes" class="form-control" rows="5">{{ old('important_notes') }}</textarea>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="slope" class="form-control" value="{{ old('slope') }}">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="avg_backpack_weight" class="form-control" value="{{ old('avg_backpack_weight') }}" step="0.1" min="0">
                    </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="local_language" class="form-control" value="{{ old('local_language') }}">
                    </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="participants_count" class="form-control" value="{{ old('participants_count') }}" min="0">
                    </div>
                </div>
