{{-- Admin notifications index view. --}}
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <form action="{{ route('admin.notifications.readAll') }}" method="POST" id="markAllReadForm">
            @csrf
            <button type="submit" class="btn btn-sm btn-outline-primary">علامت‌زدن همه به عنوان خوانده شده</button>
        </form>
    </div>
                            ...
                            <tr class="{{ $notification->is_read ? '' : 'table-light' }}">
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <form action="{{ route('admin.notifications.destroy', $notification) }}" method="POST" onsubmit="return confirm('حذف اعلان؟');">
                                            @csrf
                                            @method('DELETE')
